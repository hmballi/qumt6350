...
ridgetune <- train(x = atrainpredictors[, -1], y = trainRings,
                   ...
                   tuneGrid = ridgegrid,
                   trControl = control)
ridgetune #RMSE = .0000000000000644
...
#MARS
set.seed(127)
amars <- train(x = atrainpredictors[, -1], y = trainRings,
               method = "earth",
